    ...
    <div className="row mt-5 mb-5 justify-content-center">
      <div className="col-lg-7 col-sm-12 mt-5">
        ...
        <p className="fs-4 mt-5 text-center">
          ...
          À ce jour, structures sont référencées. L'outil de recherche ci-dessous vous permet d'accéder aux acteur·ices autour de vous selon les services qu'ielles proposent.
        </p>
